...
```{r}
ncvs_df <- read.csv("/Users/dannyzweben/Desktop/CABLAB_Files/ncvs/ncvs_data.csv")  # read CSV into dataframe
...
print(doc, target = "/Users/dannyzweben/Desktop/CABLAB_Files/ncvs/R_tables/cooffense_pairing_matrix.docx")
...
save_as_docx(
  ...
  path = "/Users/dannyzweben/Desktop/CABLAB_Files/ncvs/R_tables/combinedco_ncvs_calc_1_table.docx"
)
...
save_as_docx(
  ...
  path = "/Users/dannyzweben/Desktop/CABLAB_Files/ncvs/R_tables/combinedco-ncvs_percentages_table.docx"
)
...
# 2. Construct matrix: (alone + observed) vs group
alone_matrix <- cbind(
  alone = df$alone + df$observed,
  not_alone = df$grand_total - (df$alone + df$observed)
)
...
# 12. Save to Word doc
save_as_docx(
  "Table X. Chi-Square Tests of Non-Group Crime (Alone + Observed) by Age Group" = ft,
  path = "/Users/dannyzweben/Desktop/CABLAB_Files/ncvs/cooffending/R_tables/combinedco-chi_squared_table.docx"
)
...
# 2. Create new "non_group" variable: alone + observed
df$non_group <- df$alone + df$observed

# 3. Fit logistic regression: non_group vs. group
model <- glm(cbind(non_group, grand_total - non_group) ~ age_group, data = df, family = binomial)

# 4. Tidy output into readable odds ratios and confidence intervals
...
# 9. Export to .docx
save_as_docx(
  "Logistic Regression Results (Non-Group Offending by Age Group)" = ft,
  path = "/Users/dannyzweben/Desktop/CABLAB_Files/ncvs/cooffending/R_tables/Combinedcof-15-17int-logistic_regression_non_group_offending.docx"
)
...
print(doc, target = "/Users/dannyzweben/Desktop/CABLAB_Files/ncvs/R_tables/Combinedcof-12-14int-logistic_regression_solo_offending.docx")
...
# 7. Rename columns for APA-style output
...
# 9. Export to Word
save_as_docx(
  "Logistic Regression Results (Non-Group Offending, Reference = 18–20)" = ft,
  path = "/Users/dannyzweben/Desktop/CABLAB_Files/ncvs/cooffending/R_tables/Combinedcof-18-20-int-logistic_regression_non_group_offending.docx"
)
