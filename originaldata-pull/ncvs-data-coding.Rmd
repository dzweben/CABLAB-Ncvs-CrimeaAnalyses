...
years <- 2014:2022
input_dir <- "/Users/dannyzweben/Desktop/CABLAB_Files/ncvs/originaldata-pull/raw-ncvs-data/"
output_file <- "/Users/dannyzweben/Desktop/CABLAB_Files/ncvs/originaldata-pull/coded_data/ncvs_2014_2022_incident_full.csv"
...
for (yr in years) {
  file_path <- paste0(input_dir, yr, ".csv")
...
final_df <- final_df %>%
  mutate(
    ...
    oldest_multiple = recode(oldest_multiple,
                             `1` = "Under 12",
                             `2` = "12–14",
                             `3` = "15–17",
                             `4` = "18–20",
    ...
    youngest_multiple = recode(youngest_multiple,
                               `1` = "Under 12",
                               `2` = "12–14",
                               `3` = "15–17",
                               `4` = "18–20",
    ...
    others_present = recode(others_present,
                            `1` = "yes",
                            `2` = "no",
                            `3` = NA_character_,
                            `8` = NA_character_,
    ...
    others_help = recode(others_help,
                         `1` = "yes",
                         `2` = "no",
                         `3` = NA_character_,
                         `8` = NA_character_,
    ...
    others_harm = recode(others_harm,
                         `1` = "yes",
                         `2` = "no",
                         `3` = NA_character_,
                         `8` = NA_character_,
...
```{r}
write.csv(final_df, "~/Desktop/CABLAB_Files/ncvs/originaldata-pull/coded_data/ncvs-merged-data-2014-2022.csv", row.names = FALSE)

write.csv(final_df, "~/Desktop/CABLAB_Files/ncvs/ncvs-merged-data-2014-2022.csv", row.names = FALSE)

write.csv(ncvs_theft, "~/Desktop/CABLAB_Files/ncvs/theft-ncvs-merged-data-2014-2022.csv", row.names = FALSE)

write.csv(ncvs_violent, "~/Desktop/CABLAB_Files/ncvs/violent-ncvs-merged-data-2014-2022.csv", row.names = FALSE)
