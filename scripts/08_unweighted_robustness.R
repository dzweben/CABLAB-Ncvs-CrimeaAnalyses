# ===========================================================================
# 08 — Unweighted Robustness Checks (Supplement)
#
# Replicates the full Analysis 1 pipeline without survey weights as a
# robustness check. Covers Total, Violent, Theft, and Co-offending scopes.
#
# Input:  data/derived/ncvs-merged-data-1993-2024.csv (+ violent/theft)
# Output: outputs/supplement/*.docx
#
...
out_base <- file.path("outputs", "supplement")
...
run_scope("total_main",   "data/derived/ncvs-merged-data-1993-2024.csv", kind="main")
run_scope("theft_main",   "data/derived/theft-ncvs-merged-data-1993-2024.csv", kind="main")
run_scope("violent_main", "data/derived/violent-ncvs-merged-data-1993-2024.csv", kind="main")
run_scope("total_backup_cooffending_only", "data/derived/ncvs-merged-data-1993-2024.csv", kind="backup")
