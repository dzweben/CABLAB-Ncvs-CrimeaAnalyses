...
write.csv(ncvs_pairing_df,
          file = "total/weighted/R_Tables/cooffense_pairing_matrix.csv",
          row.names = FALSE)
...
save_as_docx(
  ...
  path = "total/weighted/R_Tables/combinedco_ncvs_calc_1_table.docx"
)
...
save_as_docx(
  ...
  path = "total/weighted/R_Tables/combinedco-ncvs_percentages_table.docx"
)
...
save_as_docx(
  ...
  path = "total/weighted/R_Tables/combinedco-chi_squared_table.docx"
)
...
save_as_docx(
  ...
  path = "total/weighted/R_Tables/Combinedcof-15-17int-logistic_regression_solo_offending.docx"
)
...
save_as_docx(
  ...
  path = "total/weighted/R_Tables/Centered18-20_logistic_regression_solo_offending.docx"
)
